...
<hr>
  ...
  * [ License ](#License)
  ...
  ## Project Objective
  When joining a new team, the new team member will be expected to inspect a lot of code that he/she has never seen before. Rather than having another team member explain every line, the new team member will dissect the code by him/herself, saving any questions for another member of the team.

  This project requires to reverse engineer the starter code provided and create a tutorial for the code. 
  ...
  ## Technologies 
  ```
  Javascript, HTML, express, express-session, passport, sequelize, Mysql, bcryptjs
  ```
